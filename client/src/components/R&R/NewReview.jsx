...
class NewReview extends React.Component {
  ...
  characterCounter(e) {
    ...
    if (charsLeft > 0) {
      this.setState({
        count: `Minimum required characters left: ${charsLeft}`,
      });
    } else {
  ...
  processCharSelection(name, value) {
    ...
    this.setState({ characteristics: update });
  }
  ...
  dataValidator() {
    ...
    if (stars === null) {
      errors.rating = 'Please select Overall Rating.';
    }
    if (Object.keys(characteristics).length === 0) {
      errors.characteristics = 'Please rate product characteristics.';
    }
    if (nickname.length === 0) {
      errors.nickname = 'Please provide your nickname.';
    }
    if (email.length === 0) {
    ...
    if (body.length < 50) {
      errors.body =
        'Please make sure the Review Body is at least 50 characters.';
    }
  ...
  toggleImgWindow(e) {
    ...
    this.setState(
      ...
      () =>
        console.log(
          'submit IMG button clicked, current state >>>>',
          this.state.imgWindow
        )
    );
  }
  ...
  render() {
    ...
    let charNames =
      this.props.characteristics && Object.keys(this.props.characteristics);
    ...
    if (this.state.show) {
          ...
          <ModalWrapper>
            ...
            <form>
              ...
              <label>
                ...
                {charNames.map((char, key) => (
                  <NewReviewChars
                    ...
                    processCharSelection={this.processCharSelection}
                  />
                ))}
              </label>
              <br />
              ...
              <label>
                ...
                <br />
                <small style={{ fontStyle: 'italic' }}>
                  {'For authetication reasons; you will not be emailed'}
                </small>
              </label>
              <br />
              <br />
              ...
              <label>
                ...
                <textarea
                  ...
                  maxLength='1000'
                  onChange={(e) =>
                    this.handleInputChange(e, this.characterCounter)
                  }
                />
              </label>
              <br />
              ...
              {this.state.showError && (
                <div style={{ color: 'red', fontWeight: 'bold' }}>
                  {' '}
                  Submission Failed. Please fix the below issue(s):{' '}
                </div>
              )}
              {this.state.showError &&
                Object.values(this.state.errors).map((errors, key) => (
      ...
      return (
        <div>
          <button style={{ cursor: 'pointer' }} onClick={this.toggleModal}>
            Add a Review
          </button>
        </div>
      );
