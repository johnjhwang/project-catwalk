...
module.exports = {
  ...
  update: function (review_id, action, callback) {
    // mark review as helpful and report review (PUT /reviews/:review_id/helpful) (PUT /reviews/:review_id/report)
    console.log('review id/action >>>', review_id, action);
    axios
      .put(`/reviews/${review_id}/${action}`)
      .then((responseData) => {
